...
@pytest.mark.parametrize("elf,expected",
       [('ldr_disp.elf',    StateChecker(pc=(12 + RESET_ADDR), rf0=0xFFFFFFFF,
                                         rf1=0x00100000)),
        ('ldr_disp_pm.elf', StateChecker(pc=(14 + RESET_ADDR), rf0=0xFFFFFFFF,
                                         rf1=0x00100004)),
        ('ldr_index.elf',   StateChecker(pc=(16 + RESET_ADDR), rf0=0xFFFFFFFF,
                                         rf1=0x00100004, rf2=0)),
        ('ldr_pm.elf',      StateChecker(pc=(20 + RESET_ADDR), rf0=0xFFFFFFFF,
                                         rf1=0x00100004, rf2=0x80002)),
       ])
...
@pytest.mark.parametrize("elf,expected",
       [('str_disp.elf', StateChecker(pc=(20 + RESET_ADDR), rf0=0xFFFFFFFF, rf1=0x00100000)),
        ('str_disp_pm.elf', StateChecker(pc=(22 + RESET_ADDR), rf0=0xFFFFFFFF, rf1=0x00100004)),
        ('str_index.elf', StateChecker(pc=(24 + RESET_ADDR), rf0=0xFFFFFFFF, rf1=0x00100004, rf2=0)),
        ('str_pm.elf', StateChecker(pc=(22 + RESET_ADDR), rf0=0xFFFFFFFF, rf1=0x00100004, rf2=4)),
       ])
...
def test_testset32():
    ...
    with open(elf_filename, 'rb') as elf:
        ...
        epiphany.run()
        expected = StateChecker(pc=(22 + RESET_ADDR), AZ=1, rf0=0, rf1=0x100000, rf2=0x4)
